---
title: "all the cool stuff my astro MDX component can do: MDX blog features"
description: "A comprehensive guide to styling and formatting options available in my blog"
pubDate: 2025-02-27
---
...
>
> feel free to use it for your own stuff! check it out here: [github.com/devansh1401/meee](https://github.com/devansh1401/meee)
...
<Tweet id="https://x.com/itssdevk/status/1812366457961066938" />
...
<YouTube
  id="https://youtu.be/ekr2nIex040?si=G7nPINcd45g1pqKC"
  posterQuality="max"
/>
...
_Italic text_ is created with single asterisks or single underscores.

~~Strikethrough~~ is created with double tildes.

Combined **bold and _italic_** formatting is also supported.
...
- This is the third item with a [link](#links) inside it
...
3. Third item with **bold text** inside it
...
- [x] Completed task
- [ ] Incomplete task
- [x] Another completed task with _italic text_

## Links

[Regular links](https://example.com) have an indigo color (#818cf8) with underline.

[Links with hover](https://example.com) change to a lighter indigo (#a5b4fc) when hovered.

### Internal Links

You can link to [other sections](#lists) within the same document.
...
```js {2,4} title="highlighted-lines.js"
function greet(name) {
...
<span class="path">/src/layouts/LayoutBlogPost.astro</span>

## Images

Images have rounded corners, a subtle border, and responsive sizing:

![Example Image Description](https://via.placeholder.com/800x400)
...
<div class="note">
  <strong>Note:</strong> This is a note callout. Use it for additional
  information or tips.
</div>

<div class="warning">
  <strong>Warning:</strong> This is a warning callout. Use it to highlight
  potential issues.
</div>

<div class="error">
  <strong>Error:</strong> This is an error callout. Use it to highlight critical
  problems.
</div>
